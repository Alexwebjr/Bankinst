...
//:::::::: DOM :::::::::
var account = document.getElementById('accountId').value; //?LOGIN

var loginForm = document.querySelector('.login__form');
var loginBtn = document.querySelector('#logIn_btn');
var logoutBtn = document.querySelector('#logOut_btn');
var loginEmail = document.querySelector('.login__input--user');
var loginPin = document.querySelector('.login__input--pin'); //?MOVEMENTS

var withdrawForm = document.querySelector('.form--transfer');
var withdrawTo = document.querySelector('.form__input--to');
var withdrawAmount = document.querySelector('.form__input--amount');
var depositForm = document.querySelector('.form--loan');
var depositAmount = document.querySelector('.form__input--loan-amount'); // const closeForm = document.querySelector('.form--close');
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(type, amount, accountId) {
    var otherId,
        res,
        _args3 = arguments;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            otherId = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : null;
            _context3.prev = 1;
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success' && otherId === null) {
              (0, _alerts.showAlert)('success', 'Movement created successfully!');
              window.setTimeout(function () {
                location.assign('/overview');
              }, 1500);
            }
  ...
  return function postMovement(_x3, _x4, _x5) {
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee4(email, pin, accountId) {
  ...
  return function closeAccount(_x6, _x7, _x8) {
...
if (withdrawForm) {
  withdrawForm.addEventListener('submit', function (e) {
    ...
    var wdAccount = +withdrawTo.value;
